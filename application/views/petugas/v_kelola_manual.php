...
<div class="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
    <div class="px-5 py-4 border-b border-slate-100 flex items-center justify-between">
        <h3 class="font-bold text-darkblue text-sm uppercase tracking-wider">
            Data Laporan - <?= htmlspecialchars($pos->nama_pos) ?>
        </h3>
    ...
    <div class="overflow-auto max-h-[500px]">
        <table class="w-full text-xs md:text-sm">
            ...
            <tbody class="divide-y divide-slate-100">
                ...
                <?php endforeach; else: ?>
                <tr><td colspan="4" class="px-5 py-12 text-center text-slate-400"><p class="text-xs md:text-sm font-medium">Belum ada data pada tanggal ini</p></td></tr>
                <?php endif; ?>
            </tbody>
        </table>
    </div>
