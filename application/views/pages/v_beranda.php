...
// =============================================
// FUNGSI FORMAT TANGGAL UNTUK POPUP
// =============================================
...
// =============================================
// FUNGSI FORMAT ANGKA (Ribuan dengan titik, desimal dengan koma)
// =============================================
function idNum(val, dec) {
    if (val === null || val === undefined || val === '' || isNaN(parseFloat(val))) return null;
    var num = parseFloat(val);
    var fixed = num.toFixed(dec !== undefined ? dec : 2);
    var parts = fixed.split('.');
    var integerPart = parts[0];
    var decimalPart = parts.length > 1 ? ',' + parts[1] : '';
    var thousands = integerPart.replace(/\B(?=(\d{3})+(?!\d))/g, '.');
    return thousands + decimalPart;
}

function idNumInt(val) {
...
function idNum1(val) {
    if (val === null || val === undefined || val === '' || isNaN(parseFloat(val))) return '0,0';
    var num = parseFloat(val);
...
function idNum2(val) {
    if (val === null || val === undefined || val === '' || isNaN(parseFloat(val))) return '0,00';
    var num = parseFloat(val);
...
function idNum3(val) {
    if (val === null || val === undefined || val === '' || isNaN(parseFloat(val))) return '0,000';
    var num = parseFloat(val);
...
function renderBendungan(data, layer) {
    ...
    data.forEach(function(p) {
        ...
        var pop = '<div style="width:' + pw + 'px;background:#fff;border-radius:16px;overflow:hidden;font-family:Inter,sans-serif;"><div style="background:#EF4444;padding:12px 14px;color:#fff;"><div style="display:flex;align-items:center;gap:6px;margin-bottom:4px;"><span style="width:7px;height:7px;border-radius:50%;background:#FCA5A5;flex-shrink:0;"></span><span style="font-size:8px;font-weight:700;text-transform:uppercase;letter-spacing:0.1em;color:#fff;">Bendungan</span></div><h4 style="font-size:' + fh + ';font-weight:800;margin:0;line-height:1.2;">' + p.nama_pos + '</h4><p style="font-size:9px;color:rgba(255,255,255,0.7);margin:3px 0 0 0;">ID: ' + p.id_pos + ' | Sungai: ' + (p.sungai || '-') + '</p></div><div style="padding:12px 14px;"><div style="display:grid;grid-template-columns:1fr 1fr;gap:8px;margin-bottom:10px;"><div style="background:#fef2f2;border-radius:10px;padding:10px 8px;text-align:center;border:1px solid #fecaca;"><p style="font-size:7px;font-weight:700;text-transform:uppercase;letter-spacing:0.05em;color:#EF4444;margin:0 0 2px 0;">Elevasi / TMA</p><p style="font-size:' + fv + ';font-weight:800;color:#1e293b;margin:0;line-height:1;">' + (idNum2(p.elevasi) || '0,00') + '</p><p style="font-size:8px;color:#94a3b8;margin:1px 0 0 0;">m</p></div><div style="background:#fefce8;border-radius:10px;padding:10px 8px;text-align:center;border:1px solid #fef08a;"><p style="font-size:7px;font-weight:700;text-transform:uppercase;letter-spacing:0.05em;color:#eab308;margin:0 0 2px 0;">Curah Hujan</p><p style="font-size:' + fv + ';font-weight:800;color:#1e293b;margin:0;line-height:1;">' + (idNum1(p.rain) || '0,0') + '</p><p style="font-size:8px;color:#94a3b8;margin:1px 0 0 0;">mm</p></div></div><div style="border-top:1px solid #f1f5f9;padding-top:8px;"><div style="display:flex;justify-content:space-between;align-items:center;padding:4px 0;"><span style="font-size:9px;color:#64748b;">Volume</span><span style="font-size:9px;font-weight:700;color:#1e293b;">' + (idNum2(p.volume) || '0,00') + ' jt.m³</span></div><div style="display:flex;justify-content:space-between;align-items:center;padding:4px 0;"><span style="font-size:9px;color:#64748b;">Inflow</span><span style="font-size:9px;font-weight:700;color:#059669;">' + (idNum3(p.inflow) || '0,000') + ' m³/s</span></div><div style="display:flex;justify-content:space-between;align-items:center;padding:4px 0;"><span style="font-size:9px;color:#64748b;">Outflow</span><span style="font-size:9px;font-weight:700;color:#EF4444;">' + (idNum3(p.total_outflow) || '0,000') + ' m³/s</span></div><div style="display:flex;justify-content:space-between;align-items:center;padding:4px 0;"><span style="font-size:9px;color:#64748b;">NWL</span><span style="font-size:9px;font-weight:700;color:#1e293b;">' + (idNum2(p.nwl) || '0,00') + ' m</span></div>' + 
            ...
            (p.elevasi_mercu != null && p.elevasi_mercu !== '' ? '<div style="display:flex;justify-content:space-between;align-items:center;padding:4px 0;"><span style="font-size:9px;color:#64748b;">Elevasi Mercu</span><span style="font-size:9px;font-weight:700;color:#1e293b;">' + idNum2(p.elevasi_mercu) + ' m</span></div>' : '') +
            (p.luas_das != null && p.luas_das !== '' ? '<div style="display:flex;justify-content:space-between;align-items:center;padding:4px 0;"><span style="font-size:9px;color:#64748b;">Luas DAS</span><span style="font-size:9px;font-weight:700;color:#1e293b;">' + idNum2(p.luas_das) + ' km²</span></div>' : '') +
...
function renderBendung(data, layer) {
    ...
    data.forEach(function(p) {
        ...
        var fh = pw < 300 ? '15px' : '17px';
        var fv = pw < 300 ? '20px' : '24px';
        var pop = '<div style="width:' + pw + 'px;background:#fff;border-radius:16px;overflow:hidden;font-family:Inter,sans-serif;"><div style="background:#06B6D4;padding:12px 14px;color:#fff;"><div style="display:flex;align-items:center;gap:6px;margin-bottom:4px;"><span style="width:7px;height:7px;border-radius:50%;background:#67E8F9;flex-shrink:0;"></span><span style="font-size:8px;font-weight:700;text-transform:uppercase;letter-spacing:0.1em;color:#fff;">Bendung</span></div><h4 style="font-size:' + fh + ';font-weight:800;margin:0;line-height:1.2;">' + p.nama_pos + '</h4><p style="font-size:9px;color:rgba(255,255,255,0.7);margin:3px 0 0 0;">Sungai: ' + (p.sungai || '-') + ' | ID: ' + p.id_pos + '</p></div><div style="padding:12px 14px;"><div style="display:grid;grid-template-columns:1fr 1fr;gap:8px;margin-bottom:10px;"><div style="background:#ecfeff;border-radius:10px;padding:10px 8px;text-align:center;border:1px solid #a5f3fc;"><p style="font-size:7px;font-weight:700;text-transform:uppercase;letter-spacing:0.05em;color:#06B6D4;margin:0 0 2px 0;">Elevasi Mercu</p><p style="font-size:' + fv + ';font-weight:800;color:#1e293b;margin:0;line-height:1;">' + (idNum2(p.elevasi_mercu) || '0,00') + '</p><p style="font-size:8px;color:#94a3b8;margin:1px 0 0 0;">m</p></div><div style="background:#fefce8;border-radius:10px;padding:10px 8px;text-align:center;border:1px solid #fef08a;"><p style="font-size:7px;font-weight:700;text-transform:uppercase;letter-spacing:0.05em;color:#eab308;margin:0 0 2px 0;">Curah Hujan</p><p style="font-size:' + fv + ';font-weight:800;color:#1e293b;margin:0;line-height:1;">' + (idNum1(p.rain) || '0,0') + '</p><p style="font-size:8px;color:#94a3b8;margin:1px 0 0 0;">mm</p></div></div><div style="border-top:1px solid #f1f5f9;padding-top:8px;"><div style="display:flex;justify-content:space-between;align-items:center;padding:4px 0;"><span style="font-size:9px;color:#64748b;">Q-Total</span><span style="font-size:9px;font-weight:700;color:#1e293b;">' + (idNum3(p.q_total) || '0,000') + ' m³/dt</span></div><div style="display:flex;justify-content:space-between;align-items:center;padding:4px 0;"><span style="font-size:9px;color:#64748b;">Q-FC1</span><span style="font-size:9px;font-weight:700;color:#059669;">' + (idNum3(p.q_fc1) || '0,000') + ' m³/dt</span></div><div style="display:flex;justify-content:space-between;align-items:center;padding:4px 0;"><span style="font-size:9px;color:#64748b;">Q-FC2</span><span style="font-size:9px;font-weight:700;color:#3B82F6;">' + (idNum3(p.q_fc2) || '0,000') + ' m³/dt</span></div><div style="display:flex;justify-content:space-between;align-items:center;padding:4px 0;"><span style="font-size:9px;color:#64748b;">Q-Sal. Induk</span><span style="font-size:9px;font-weight:700;color:#D97706;">' + (idNum3(p.q_sal_induk) || '0,000') + ' m³/dt</span></div><div style="display:flex;justify-content:space-between;align-items:center;padding:4px 0;"><span style="font-size:9px;color:#64748b;">Q-Limpas</span><span style="font-size:9px;font-weight:700;color:#EF4444;">' + (idNum3(p.q_limpas) || '0,000') + ' m³/dt</span></div><div style="display:flex;justify-content:space-between;align-items:center;padding:4px 0;"><span style="font-size:9px;color:#64748b;">Q-Sungai</span><span style="font-size:9px;font-weight:700;color:#0891B2;">' + (idNum3(p.q_sungai) || '0,000') + ' m³/dt</span></div><div style="display:flex;justify-content:space-between;align-items:center;padding:4px 0;"><span style="font-size:9px;color:#64748b;">Q-SPAM KPBU</span><span style="font-size:9px;font-weight:700;color:#8B5CF6;">' + (idNum3(p.q_spam_kpbu) || '0,000') + ' m³/dt</span></div><div style="display:flex;justify-content:space-between;align-items:center;padding:4px 0;"><span style="font-size:9px;color:#64748b;">Sluice Gate</span><span style="font-size:9px;font-weight:700;color:#1e293b;">' + (idNum3(p.sluice_gate) || '0,000') + '</span></div><div style="display:flex;justify-content:space-between;align-items:center;padding:4px 0;"><span style="font-size:9px;color:#64748b;">Bukaan Pintu</span><span style="font-size:9px;font-weight:700;color:#1e293b;">' + (idNum3(p.bukaan_pintu) || '0,000') + ' m</span></div></div><div style="border-top:1px solid #f1f5f9;margin-top:8px;padding-top:8px;"><div style="display:flex;justify-content:space-between;align-items:center;"><span style="font-size:8px;color:#94a3b8;">Update</span><span style="font-size:8px;font-weight:600;color:#475569;">' + fmtUpdate(p.created_at) + '</span></div></div></div></div>';
        m.bindPopup(pop, { maxWidth: pw, minWidth: pw, className: 'custom-leaflet-popup', offset: [0, -6] });
        m.bindTooltip(p.nama_pos, { direction: 'top', offset: [0, -10] });
    });
}
...
function renderPengaman(data, layer) {
    ...
    data.forEach(function(p) {
        ...
        var pop = '<div style="width:' + pw + 'px;background:#fff;border-radius:16px;overflow:hidden;font-family:Inter,sans-serif;"><div style="background:#F97316;padding:12px 14px;color:#fff;"><div style="display:flex;align-items:center;gap:6px;margin-bottom:4px;"><span style="width:7px;height:7px;border-radius:50%;background:#FDBA74;flex-shrink:0;"></span><span style="font-size:8px;font-weight:700;text-transform:uppercase;letter-spacing:0.1em;color:#fff;">Pengaman Pantai</span></div><h4 style="font-size:' + fh + ';font-weight:800;margin:0;line-height:1.2;">' + p.nama_aset + '</h4><p style="font-size:9px;color:rgba(255,255,255,0.7);margin:3px 0 0 0;">' + jenis + ' | ' + kab + '</p></div><div style="padding:12px 14px;"><div style="display:grid;grid-template-columns:1fr 1fr 1fr;gap:6px;margin-bottom:10px;"><div style="background:#fff7ed;border-radius:10px;padding:10px 6px;text-align:center;border:1px solid #fdba74;"><p style="font-size:7px;font-weight:700;text-transform:uppercase;letter-spacing:0.05em;color:#F97316;margin:0 0 2px 0;">Panjang</p><p style="font-size:' + fv + ';font-weight:800;color:#1e293b;margin:0;line-height:1;">' + idNumInt(p.panjang) + '</p><p style="font-size:8px;color:#94a3b8;margin:1px 0 0 0;">m</p></div><div style="background:#fff7ed;border-radius:10px;padding:10px 6px;text-align:center;border:1px solid #fdba74;"><p style="font-size:7px;font-weight:700;text-transform:uppercase;letter-spacing:0.05em;color:#F97316;margin:0 0 2px 0;">Elevasi Puncak</p><p style="font-size:' + fv + ';font-weight:800;color:#1e293b;margin:0;line-height:1;">' + idNum2(p.elevasi_puncak) + '</p><p style="font-size:8px;color:#94a3b8;margin:1px 0 0 0;">mdpl</p></div><div style="background:#fff7ed;border-radius:10px;padding:10px 6px;text-align:center;border:1px solid #fdba74;"><p style="font-size:7px;font-weight:700;text-transform:uppercase;letter-spacing:0.05em;color:#F97316;margin:0 0 2px 0;">Lebar Puncak</p><p style="font-size:' + fv + ';font-weight:800;color:#1e293b;margin:0;line-height:1;">' + idNum2(p.lebar_puncak) + '</p><p style="font-size:8px;color:#94a3b8;margin:1px 0 0 0;">m</p></div></div><div style="border-top:1px solid #f1f5f9;padding-top:8px;"><div style="display:flex;justify-content:space-between;align-items:center;padding:4px 0;"><span style="font-size:9px;color:#64748b;">Jenis</span><span style="font-size:9px;font-weight:700;color:#1e293b;">' + jenis + '</span></div><div style="display:flex;justify-content:space-between;align-items:center;padding:4px 0;"><span style="font-size:9px;color:#64748b;">Wilayah Sungai</span><span style="font-size:9px;font-weight:700;color:#1e293b;">' + ws + '</span></div><div style="display:flex;justify-content:space-between;align-items:center;padding:4px 0;"><span style="font-size:9px;color:#64748b;">DAS</span><span style="font-size:9px;font-weight:700;color:#1e293b;">' + das + '</span></div><div style="display:flex;justify-content:space-between;align-items:center;padding:4px 0;"><span style="font-size:9px;color:#64748b;">Tahun</span><span style="font-size:9px;font-weight:700;color:#1e293b;">' + tahun + '</span></div></div><div style="border-top:1px solid #f1f5f9;margin-top:8px;padding-top:8px;"><div style="display:flex;justify-content:space-between;align-items:center;padding:4px 0;"><span style="font-size:9px;color:#64748b;">Kecamatan</span><span style="font-size:9px;font-weight:700;color:#1e293b;">' + kec + '</span></div><div style="display:flex;justify-content:space-between;align-items:center;padding:4px 0;"><span style="font-size:9px;color:#64748b;">Desa</span><span style="font-size:9px;font-weight:700;color:#1e293b;">' + desa + '</span></div><div style="display:flex;justify-content:space-between;align-items:center;padding:4px 0;"><span style="font-size:9px;color:#64748b;">Manfaat</span><span style="font-size:9px;font-weight:700;color:#F97316;max-width:180px;text-align:right;">' + manfaat + '</span></div></div><div style="border-top:1px solid #f1f5f9;margin-top:8px;padding-top:8px;"><div style="display:flex;justify-content:space-between;align-items:center;"><span style="font-size:8px;color:#94a3b8;">Update</span><span style="font-size:8px;font-weight:600;color:#475569;">' + fmtUpdate(p.created_at) + '</span></div></div></div></div>';
...
function renderIrigasi(data, layer) {
    ...
    data.forEach(function(p) {
        ...
        var kab = p.kabupaten_kota || '-';
        var luasBaku = idNumInt(p.luas_baku) || '0';
        var luasFungsional = idNumInt(p.luas_fungsional) || '0';
        var luasPotensial = idNumInt(p.luas_potensial) || '0';
