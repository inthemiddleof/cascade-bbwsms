...
<header class="relative w-full h-screen min-h-[500px] md:min-h-[600px] overflow-hidden">
    ...
    <!-- DESKTOP: LAYER PANEL - DIPECAH PER WS -->
    <div id="desktop-panel-layer" class="desktop-slide-panel hidden lg:block absolute top-1/2 -translate-y-1/2 left-[76px] z-[1000] bg-white/40 backdrop-blur-xl rounded-2xl shadow-xl shadow-black/5 border border-white/30 p-4 w-64 opacity-0 invisible -translate-y-2 transition-all duration-300 ease-out">
        ...
        <div class="mt-1 mb-0.5">
            <p class="text-[8px] font-bold text-indigo-600 uppercase tracking-wider">Mesuji-Tulang Bawang</p>
        </div>
        <label class="flex items-center gap-2 px-2 py-1 rounded-lg cursor-pointer bg-indigo-50/50 hover:bg-indigo-100/50 transition-all border border-indigo-200/30"><input type="checkbox" checked onchange="toggleWS('MTB',this)" class="w-3.5 h-3.5 rounded accent-indigo-500"><span class="text-[9px] font-medium text-slate-600">Semua</span></label>
        <div class="grid grid-cols-2 gap-0.5 ml-1">
            ...
            <label class="flex items-center gap-1.5 px-1.5 py-0.5 rounded cursor-pointer hover:bg-white/30 transition-all"><input type="checkbox" checked onchange="toggleLayer('embung_MTB',this)" class="w-3 h-3 rounded accent-emerald-500"><span class="text-[8px] text-slate-500">Embung</span></label>
            <label class="flex items-center gap-1.5 px-1.5 py-0.5 rounded cursor-pointer hover:bg-white/30 transition-all"><input type="checkbox" checked onchange="toggleLayer('pengaman_MTB',this)" class="w-3 h-3 rounded accent-orange-500"><span class="text-[8px] text-slate-500">Pengaman Pantai</span></label>
            <label class="flex items-center gap-1.5 px-1.5 py-0.5 rounded cursor-pointer hover:bg-white/30 transition-all"><input type="checkbox" checked onchange="toggleLayer('sedimen_MTB',this)" class="w-3 h-3 rounded accent-yellow-500"><span class="text-[8px] text-slate-500">Pengendali Sedimen</span></label>
            <label class="flex items-center gap-1.5 px-1.5 py-0.5 rounded cursor-pointer hover:bg-white/30 transition-all"><input type="checkbox" checked onchange="toggleLayer('irigasi_MTB',this)" class="w-3 h-3 rounded accent-green-500"><span class="text-[8px] text-slate-500">Daerah Irigasi</span></label>
        ...
        <div class="mt-1 mb-0.5">
            <p class="text-[8px] font-bold text-blue-600 uppercase tracking-wider">Seputih-Sekampung</p>
        </div>
        <label class="flex items-center gap-2 px-2 py-1 rounded-lg cursor-pointer bg-blue-50/50 hover:bg-blue-100/50 transition-all border border-blue-200/30"><input type="checkbox" checked onchange="toggleWS('SS',this)" class="w-3.5 h-3.5 rounded accent-blue-500"><span class="text-[9px] font-medium text-slate-600">Semua</span></label>
        <div class="grid grid-cols-2 gap-0.5 ml-1">
            ...
            <label class="flex items-center gap-1.5 px-1.5 py-0.5 rounded cursor-pointer hover:bg-white/30 transition-all"><input type="checkbox" checked onchange="toggleLayer('embung_SS',this)" class="w-3 h-3 rounded accent-emerald-500"><span class="text-[8px] text-slate-500">Embung</span></label>
            <label class="flex items-center gap-1.5 px-1.5 py-0.5 rounded cursor-pointer hover:bg-white/30 transition-all"><input type="checkbox" checked onchange="toggleLayer('pengaman_SS',this)" class="w-3 h-3 rounded accent-orange-500"><span class="text-[8px] text-slate-500">Pengaman Pantai</span></label>
            <label class="flex items-center gap-1.5 px-1.5 py-0.5 rounded cursor-pointer hover:bg-white/30 transition-all"><input type="checkbox" checked onchange="toggleLayer('sedimen_SS',this)" class="w-3 h-3 rounded accent-yellow-500"><span class="text-[8px] text-slate-500">Pengendali Sedimen</span></label>
            <label class="flex items-center gap-1.5 px-1.5 py-0.5 rounded cursor-pointer hover:bg-white/30 transition-all"><input type="checkbox" checked onchange="toggleLayer('irigasi_SS',this)" class="w-3 h-3 rounded accent-green-500"><span class="text-[8px] text-slate-500">Daerah Irigasi</span></label>
        ...
        <!-- WS SEMANGKA -->
        <div class="mt-1 mb-0.5">
            <p class="text-[8px] font-bold text-green-600 uppercase tracking-wider">Semangka</p>
        </div>
        <label class="flex items-center gap-2 px-2 py-1 rounded-lg cursor-pointer bg-green-50/50 hover:bg-green-100/50 transition-all border border-green-200/30"><input type="checkbox" checked onchange="toggleWS('SM',this)" class="w-3.5 h-3.5 rounded accent-green-500"><span class="text-[9px] font-medium text-slate-600">Semua</span></label>
        <div class="grid grid-cols-2 gap-0.5 ml-1">
            ...
            <label class="flex items-center gap-1.5 px-1.5 py-0.5 rounded cursor-pointer hover:bg-white/30 transition-all"><input type="checkbox" checked onchange="toggleLayer('embung_SM',this)" class="w-3 h-3 rounded accent-emerald-500"><span class="text-[8px] text-slate-500">Embung</span></label>
            <label class="flex items-center gap-1.5 px-1.5 py-0.5 rounded cursor-pointer hover:bg-white/30 transition-all"><input type="checkbox" checked onchange="toggleLayer('pengaman_SM',this)" class="w-3 h-3 rounded accent-orange-500"><span class="text-[8px] text-slate-500">Pengaman Pantai</span></label>
            <label class="flex items-center gap-1.5 px-1.5 py-0.5 rounded cursor-pointer hover:bg-white/30 transition-all"><input type="checkbox" checked onchange="toggleLayer('sedimen_SM',this)" class="w-3 h-3 rounded accent-yellow-500"><span class="text-[8px] text-slate-500">Pengendali Sedimen</span></label>
            <label class="flex items-center gap-1.5 px-1.5 py-0.5 rounded cursor-pointer hover:bg-white/30 transition-all"><input type="checkbox" checked onchange="toggleLayer('irigasi_SM',this)" class="w-3 h-3 rounded accent-green-500"><span class="text-[8px] text-slate-500">Daerah Irigasi</span></label>
...
var layerEmbung_MTB = L.layerGroup().addTo(heroMap);
var layerPengaman_MTB = L.layerGroup().addTo(heroMap);
var layerSedimen_MTB = L.layerGroup().addTo(heroMap);
var layerIrigasi_MTB = L.layerGroup().addTo(heroMap);
...
var layerEmbung_SS = L.layerGroup().addTo(heroMap);
var layerPengaman_SS = L.layerGroup().addTo(heroMap);
var layerSedimen_SS = L.layerGroup().addTo(heroMap);
var layerIrigasi_SS = L.layerGroup().addTo(heroMap);
...
var layerEmbung_SM = L.layerGroup().addTo(heroMap);
var layerPengaman_SM = L.layerGroup().addTo(heroMap);
var layerSedimen_SM = L.layerGroup().addTo(heroMap);
var layerIrigasi_SM = L.layerGroup().addTo(heroMap);
...
function addToSearchIndex(data, type, color, bgColor, zoom, latField, lngField, nameField) {
    if(data){data.forEach(function(p){
...
function renderBendungan(data, layer) {
    if(!data) return;
    data.forEach(function(p){if(!p.lat||!p.lng)return;var hasRain=(p.rain>0);var m=L.marker([parseFloat(p.lat),parseFloat(p.lng)],{icon:createCustomIcon('#EF4444',hasRain)}).addTo(layer);m.on('click',function(e){heroMap.flyTo(e.latlng,16,{animate:true,duration:1.5})});var pw=getPopupWidth();var fh=pw<300?'15px':'17px';var fv=pw<300?'20px':'24px';var pop='<div style="width:'+pw+'px;background:#fff;border-radius:16px;overflow:hidden;font-family:Inter,sans-serif;"><div style="background:#EF4444;padding:12px 14px;color:#fff;"><div style="display:flex;align-items:center;gap:6px;margin-bottom:4px;"><span style="width:7px;height:7px;border-radius:50%;background:#FCA5A5;flex-shrink:0;"></span><span style="font-size:8px;font-weight:700;text-transform:uppercase;letter-spacing:0.1em;color:#fff;">Bendungan</span></div><h4 style="font-size:'+fh+';font-weight:800;margin:0;line-height:1.2;">'+p.nama_pos+'</h4><p style="font-size:9px;color:rgba(255,255,255,0.7);margin:3px 0 0 0;">ID: '+p.id_pos+' | Sungai: '+(p.sungai||'-')+'</p></div><div style="padding:12px 14px;"><div style="display:grid;grid-template-columns:1fr 1fr;gap:8px;margin-bottom:10px;"><div style="background:#fef2f2;border-radius:10px;padding:10px 8px;text-align:center;border:1px solid #fecaca;"><p style="font-size:7px;font-weight:700;text-transform:uppercase;letter-spacing:0.05em;color:#EF4444;margin:0 0 2px 0;">Elevasi / TMA</p><p style="font-size:'+fv+';font-weight:800;color:#1e293b;margin:0;line-height:1;">'+(idNum(p.elevasi,2)||'0,00')+'</p><p style="font-size:8px;color:#94a3b8;margin:1px 0 0 0;">m</p></div><div style="background:#fefce8;border-radius:10px;padding:10px 8px;text-align:center;border:1px solid #fef08a;"><p style="font-size:7px;font-weight:700;text-transform:uppercase;letter-spacing:0.05em;color:#eab308;margin:0 0 2px 0;">Curah Hujan</p><p style="font-size:'+fv+';font-weight:800;color:#1e293b;margin:0;line-height:1;">'+(idNum(p.rain,1)||'0')+'</p><p style="font-size:8px;color:#94a3b8;margin:1px 0 0 0;">mm</p></div></div><div style="border-top:1px solid #f1f5f9;padding-top:8px;"><div style="display:flex;justify-content:space-between;align-items:center;padding:4px 0;"><span style="font-size:9px;color:#64748b;">Volume</span><span style="font-size:9px;font-weight:700;color:#1e293b;">'+(idNum(p.volume,2)||'-')+' jt.m³</span></div><div style="display:flex;justify-content:space-between;align-items:center;padding:4px 0;"><span style="font-size:9px;color:#64748b;">Inflow</span><span style="font-size:9px;font-weight:700;color:#059669;">'+(idNum(p.inflow,3)||'0')+' m³/s</span></div><div style="display:flex;justify-content:space-between;align-items:center;padding:4px 0;"><span style="font-size:9px;color:#64748b;">Outflow</span><span style="font-size:9px;font-weight:700;color:#EF4444;">'+(idNum(p.total_outflow,3)||'0')+' m³/s</span></div><div style="display:flex;justify-content:space-between;align-items:center;padding:4px 0;"><span style="font-size:9px;color:#64748b;">NWL</span><span style="font-size:9px;font-weight:700;color:#1e293b;">'+(idNum(p.nwl,2)||'-')+' m</span></div></div><div style="border-top:1px solid #f1f5f9;margin-top:8px;padding-top:8px;"><div style="display:flex;justify-content:space-between;align-items:center;"><span style="font-size:8px;color:#94a3b8;">Update</span><span style="font-size:8px;font-weight:600;color:#475569;">'+fmtUpdate(p.created_at)+'</span></div></div></div></div>';m.bindPopup(pop,{maxWidth:pw,minWidth:pw,className:'custom-leaflet-popup',offset:[0,-6]});m.bindTooltip(p.nama_pos,{direction:'top',offset:[0,-10]})});
}

function renderBendung(data, layer) {
    if(!data) return;
    data.forEach(function(p){if(!p.lat||!p.lng)return;var hasRain=(p.rain>0);var hasElevasi=(p.elevasi_mercu!=null&&parseFloat(p.elevasi_mercu)>0);var shouldPulse=hasRain||hasElevasi;var m=L.marker([parseFloat(p.lat),parseFloat(p.lng)],{icon:createCustomIcon('#06B6D4',shouldPulse)}).addTo(layer);m.on('click',function(e){heroMap.flyTo(e.latlng,15,{animate:true,duration:1.5})});var pw=getPopupWidth();var fh=pw<300?'15px':'17px';var fv=pw<300?'20px':'24px';var pop='<div style="width:'+pw+'px;background:#fff;border-radius:16px;overflow:hidden;font-family:Inter,sans-serif;"><div style="background:#06B6D4;padding:12px 14px;color:#fff;"><div style="display:flex;align-items:center;gap:6px;margin-bottom:4px;"><span style="width:7px;height:7px;border-radius:50%;background:#67E8F9;flex-shrink:0;"></span><span style="font-size:8px;font-weight:700;text-transform:uppercase;letter-spacing:0.1em;color:#fff;">Bendung</span></div><h4 style="font-size:'+fh+';font-weight:800;margin:0;line-height:1.2;">'+p.nama_pos+'</h4><p style="font-size:9px;color:rgba(255,255,255,0.7);margin:3px 0 0 0;">Sungai: '+(p.sungai||'-')+' | ID: '+p.id_pos+'</p></div><div style="padding:12px 14px;"><div style="display:grid;grid-template-columns:1fr 1fr;gap:8px;margin-bottom:10px;"><div style="background:#ecfeff;border-radius:10px;padding:10px 8px;text-align:center;border:1px solid #a5f3fc;"><p style="font-size:7px;font-weight:700;text-transform:uppercase;letter-spacing:0.05em;color:#06B6D4;margin:0 0 2px 0;">Elevasi / TMA</p><p style="font-size:'+fv+';font-weight:800;color:#1e293b;margin:0;line-height:1;">'+(idNum(p.elevasi_mercu,2)||'0,00')+'</p><p style="font-size:8px;color:#94a3b8;margin:1px 0 0 0;">m</p></div><div style="background:#fefce8;border-radius:10px;padding:10px 8px;text-align:center;border:1px solid #fef08a;"><p style="font-size:7px;font-weight:700;text-transform:uppercase;letter-spacing:0.05em;color:#eab308;margin:0 0 2px 0;">Curah Hujan</p><p style="font-size:'+fv+';font-weight:800;color:#1e293b;margin:0;line-height:1;">'+(idNum(p.rain,1)||'0,0')+'</p><p style="font-size:8px;color:#94a3b8;margin:1px 0 0 0;">mm</p></div></div><div style="border-top:1px solid #f1f5f9;padding-top:8px;"><div style="display:flex;justify-content:space-between;align-items:center;padding:4px 0;"><span style="font-size:9px;color:#64748b;">Q-Total</span><span style="font-size:9px;font-weight:700;color:#1e293b;">'+(idNum(p.q_total,3)||'0,000')+' m³/dt</span></div><div style="display:flex;justify-content:space-between;align-items:center;padding:4px 0;"><span style="font-size:9px;color:#64748b;">Q-FC1</span><span style="font-size:9px;font-weight:700;color:#059669;">'+(idNum(p.q_fc1,3)||'0,000')+' m³/dt</span></div><div style="display:flex;justify-content:space-between;align-items:center;padding:4px 0;"><span style="font-size:9px;color:#64748b;">Q-FC2</span><span style="font-size:9px;font-weight:700;color:#3B82F6;">'+(idNum(p.q_fc2,3)||'0,000')+' m³/dt</span></div><div style="display:flex;justify-content:space-between;align-items:center;padding:4px 0;"><span style="font-size:9px;color:#64748b;">Q-Limpas</span><span style="font-size:9px;font-weight:700;color:#EF4444;">'+(idNum(p.q_limpas,3)||'0,000')+' m³/dt</span></div><div style="display:flex;justify-content:space-between;align-items:center;padding:4px 0;"><span style="font-size:9px;color:#64748b;">Q-SPAM KPBU</span><span style="font-size:9px;font-weight:700;color:#8B5CF6;">'+(idNum(p.q_spam_kpbu,3)||'0,000')+' m³/dt</span></div><div style="display:flex;justify-content:space-between;align-items:center;padding:4px 0;"><span style="font-size:9px;color:#64748b;">Sluice Gate</span><span style="font-size:9px;font-weight:700;color:#1e293b;">'+(idNum(p.sluice_gate,3)||'0,000')+' m³/dt</span></div></div><div style="border-top:1px solid #f1f5f9;margin-top:8px;padding-top:8px;"><div style="display:flex;justify-content:space-between;align-items:center;"><span style="font-size:8px;color:#94a3b8;">Update</span><span style="font-size:8px;font-weight:600;color:#475569;">'+fmtUpdate(p.created_at)+'</span></div></div></div></div>';m.bindPopup(pop,{maxWidth:pw,minWidth:pw,className:'custom-leaflet-popup',offset:[0,-6]});m.bindTooltip(p.nama_pos,{direction:'top',offset:[0,-10]})});
}

function renderEmbung(data, layer) {
    if(!data) return;
    data.forEach(function(p){if(!p.lat||!p.lng)return;var hasRain=(p.rain>0);var hasElevasi=(p.elevasi!=null&&parseFloat(p.elevasi)>0);var shouldPulse=hasRain||hasElevasi;var m=L.marker([parseFloat(p.lat),parseFloat(p.lng)],{icon:createCustomIcon('#10B981',shouldPulse)}).addTo(layer);m.on('click',function(e){heroMap.flyTo(e.latlng,15,{animate:true,duration:1.5})});var pw=getPopupWidth();var fh=pw<300?'15px':'17px';var fv=pw<300?'20px':'24px';var pop='<div style="width:'+pw+'px;background:#fff;border-radius:16px;overflow:hidden;font-family:Inter,sans-serif;"><div style="background:#10B981;padding:12px 14px;color:#fff;"><div style="display:flex;align-items:center;gap:6px;margin-bottom:4px;"><span style="width:7px;height:7px;border-radius:50%;background:#6EE7B7;flex-shrink:0;"></span><span style="font-size:8px;font-weight:700;text-transform:uppercase;letter-spacing:0.1em;color:#fff;">Embung</span></div><h4 style="font-size:'+fh+';font-weight:800;margin:0;line-height:1.2;">'+p.nama_pos+'</h4><p style="font-size:9px;color:rgba(255,255,255,0.7);margin:3px 0 0 0;">Sungai: '+(p.sungai||'-')+' | ID: '+p.id_pos+'</p></div><div style="padding:12px 14px;"><div style="display:grid;grid-template-columns:1fr 1fr;gap:8px;margin-bottom:10px;"><div style="background:#ecfdf5;border-radius:10px;padding:10px 8px;text-align:center;border:1px solid #a7f3d0;"><p style="font-size:7px;font-weight:700;text-transform:uppercase;letter-spacing:0.05em;color:#10B981;margin:0 0 2px 0;">Elevasi / TMA</p><p style="font-size:'+fv+';font-weight:800;color:#1e293b;margin:0;line-height:1;">'+(idNum(p.elevasi,2)||idNum(p.elevasi_normal,2)||'0,00')+'</p><p style="font-size:8px;color:#94a3b8;margin:1px 0 0 0;">m</p></div><div style="background:#fefce8;border-radius:10px;padding:10px 8px;text-align:center;border:1px solid #fef08a;"><p style="font-size:7px;font-weight:700;text-transform:uppercase;letter-spacing:0.05em;color:#eab308;margin:0 0 2px 0;">Curah Hujan</p><p style="font-size:'+fv+';font-weight:800;color:#1e293b;margin:0;line-height:1;">'+(idNum(p.rain,1)||'0,0')+'</p><p style="font-size:8px;color:#94a3b8;margin:1px 0 0 0;">mm</p></div></div><div style="border-top:1px solid #f1f5f9;padding-top:8px;"><div style="display:flex;justify-content:space-between;align-items:center;padding:4px 0;"><span style="font-size:9px;color:#64748b;">Volume</span><span style="font-size:9px;font-weight:700;color:#1e293b;">'+(idNum(p.volume,0)||idNum(p.volume_normal,0)||'0')+' m³</span></div><div style="display:flex;justify-content:space-between;align-items:center;padding:4px 0;"><span style="font-size:9px;color:#64748b;">Luas Genangan</span><span style="font-size:9px;font-weight:700;color:#1e293b;">'+(idNum(p.luas_genangan,2)||idNum(p.luas_normal,2)||'0,00')+' Ha</span></div><div style="display:flex;justify-content:space-between;align-items:center;padding:4px 0;"><span style="font-size:9px;color:#64748b;">Inflow</span><span style="font-size:9px;font-weight:700;color:#059669;">'+(idNum(p.inflow,3)||'0,000')+' m³/s</span></div><div style="display:flex;justify-content:space-between;align-items:center;padding:4px 0;"><span style="font-size:9px;color:#64748b;">Outflow</span><span style="font-size:9px;font-weight:700;color:#EF4444;">'+(idNum(p.outflow,3)||'0,000')+' m³/s</span></div><div style="display:flex;justify-content:space-between;align-items:center;padding:4px 0;"><span style="font-size:9px;color:#64748b;">Elevasi Normal</span><span style="font-size:9px;font-weight:700;color:#1e293b;">'+(idNum(p.elevasi_normal,2)||'-')+' m</span></div></div><div style="border-top:1px solid #f1f5f9;margin-top:8px;padding-top:8px;"><div style="display:flex;justify-content:space-between;align-items:center;"><span style="font-size:8px;color:#94a3b8;">Update</span><span style="font-size:8px;font-weight:600;color:#475569;">'+fmtUpdate(p.created_at)+'</span></div></div></div></div>';m.bindPopup(pop,{maxWidth:pw,minWidth:pw,className:'custom-leaflet-popup',offset:[0,-6]});m.bindTooltip(p.nama_pos,{direction:'top',offset:[0,-10]})});
}
...
function renderIrigasi(data, layer) {
    ...
    data.forEach(function(p){
        ...
        if(!lat||!lng)return;
        var hasData = (parseFloat(p.luas_fungsional) > 0);
        var m = L.marker([lat, lng], {
            icon: createCustomIcon('#22C55E', hasData)
        }).addTo(layer);
        m.on('click',function(e){heroMap.flyTo(e.latlng,14,{animate:true,duration:1.5})});
        ...
        var tahun = p.tahun_pembangunan || '-';
        var das = p.daerah_aliran_sungai || '-';
        var ws = p.wilayah_sungai || '-';
        var deskripsi = p.deskripsi_aset || '';
        var pop='<div style="width:'+pw+'px;background:#fff;border-radius:16px;overflow:hidden;font-family:Inter,sans-serif;"><div style="background:#22C55E;padding:12px 14px;color:#fff;"><div style="display:flex;align-items:center;gap:6px;margin-bottom:4px;"><span style="width:7px;height:7px;border-radius:50%;background:#86EFAC;flex-shrink:0;"></span><span style="font-size:8px;font-weight:700;text-transform:uppercase;letter-spacing:0.1em;color:#fff;">Daerah Irigasi</span></div><h4 style="font-size:'+fh+';font-weight:800;margin:0;line-height:1.2;">'+namaDI+'</h4><p style="font-size:9px;color:rgba(255,255,255,0.7);margin:3px 0 0 0;">'+jenisDI+' | '+kab+'</p></div><div style="padding:12px 14px;"><div style="display:grid;grid-template-columns:1fr 1fr;gap:8px;margin-bottom:10px;"><div style="background:#f0fdf4;border-radius:10px;padding:10px 8px;text-align:center;border:1px solid #bbf7d0;"><p style="font-size:7px;font-weight:700;text-transform:uppercase;letter-spacing:0.05em;color:#22C55E;margin:0 0 2px 0;">Luas Baku</p><p style="font-size:'+fv+';font-weight:800;color:#1e293b;margin:0;line-height:1;">'+luasBaku+'</p><p style="font-size:8px;color:#94a3b8;margin:1px 0 0 0;">Ha</p></div><div style="background:#f0fdf4;border-radius:10px;padding:10px 8px;text-align:center;border:1px solid #bbf7d0;"><p style="font-size:7px;font-weight:700;text-transform:uppercase;letter-spacing:0.05em;color:#22C55E;margin:0 0 2px 0;">Luas Fungsional</p><p style="font-size:'+fv+';font-weight:800;color:#1e293b;margin:0;line-height:1;">'+luasFungsional+'</p><p style="font-size:8px;color:#94a3b8;margin:1px 0 0 0;">Ha</p></div></div><div style="border-top:1px solid #f1f5f9;padding-top:8px;"><div style="display:flex;justify-content:space-between;align-items:center;padding:4px 0;"><span style="font-size:9px;color:#64748b;">Luas Potensial</span><span style="font-size:9px;font-weight:700;color:#1e293b;">'+luasPotensial+' Ha</span></div><div style="display:flex;justify-content:space-between;align-items:center;padding:4px 0;"><span style="font-size:9px;color:#64748b;">Sumber Air</span><span style="font-size:9px;font-weight:700;color:#1e293b;">'+sumberAir+'</span></div><div style="display:flex;justify-content:space-between;align-items:center;padding:4px 0;"><span style="font-size:9px;color:#64748b;">Bangunan Utama</span><span style="font-size:9px;font-weight:700;color:#1e293b;">'+bangunanUtama+'</span></div><div style="display:flex;justify-content:space-between;align-items:center;padding:4px 0;"><span style="font-size:9px;color:#64748b;">Tahun</span><span style="font-size:9px;font-weight:700;color:#1e293b;">'+tahun+'</span></div><div style="display:flex;justify-content:space-between;align-items:center;padding:4px 0;"><span style="font-size:9px;color:#64748b;">DAS</span><span style="font-size:9px;font-weight:700;color:#1e293b;">'+das+'</span></div><div style="display:flex;justify-content:space-between;align-items:center;padding:4px 0;"><span style="font-size:9px;color:#64748b;">WS</span><span style="font-size:9px;font-weight:700;color:#1e293b;">'+ws+'</span></div>'+(deskripsi ? '<div style="margin-top:6px;padding-top:6px;border-top:1px solid #f1f5f9;"><p style="font-size:8px;color:#64748b;margin:0;line-height:1.4;">'+deskripsi.substring(0,150)+(deskripsi.length>150?'...':'')+'</p></div>' : '')+'</div></div></div>';
...
function renderPengaman(data, layer) {
    ...
    data.forEach(function(p){
        ...
        var latAwal=parseFloat(p.lat_awal),lngAwal=parseFloat(p.lng_awal),latAkhir=parseFloat(p.lat_akhir),lngAkhir=parseFloat(p.lng_akhir);
        var polyline=L.polyline([[latAwal,lngAwal],[latAkhir,lngAkhir]],{color:'#F97316',weight:4,opacity:0.9}).addTo(layer);
        polyline.bindTooltip(p.nama_aset,{direction:'top',offset:[0,-5],sticky:true});
        var pw=getPopupWidth();var fh=pw<300?'15px':'17px';
        var jenis=p.jenis_bangunan||'-';var panjang=p.panjang?parseFloat(p.panjang).toFixed(0):'-';var elevasi=p.elevasi_puncak?parseFloat(p.elevasi_puncak).toFixed(2):'-';var kondisi=p.kondisi_bangunan||'-';var status=p.status_operasi||'-';var tahun=p.tahun_dibangun||'-';var kab=p.kabupaten_kota||'-';var kec=p.kecamatan||'-';var desa=p.kelurahan||'-';var manfaat=p.manfaat||'-';var das=p.sungai||'-';
        var pop='<div style="width:'+pw+'px;background:#fff;border-radius:16px;overflow:hidden;font-family:Inter,sans-serif;"><div style="background:#F97316;padding:12px 14px;color:#fff;"><div style="display:flex;align-items:center;gap:6px;margin-bottom:4px;"><span style="width:7px;height:7px;border-radius:50%;background:#FDBA74;flex-shrink:0;"></span><span style="font-size:8px;font-weight:700;text-transform:uppercase;letter-spacing:0.1em;color:#fff;">Pengaman Pantai</span></div><h4 style="font-size:'+fh+';font-weight:800;margin:0;line-height:1.2;">'+p.nama_aset+'</h4><p style="font-size:9px;color:rgba(255,255,255,0.7);margin:3px 0 0 0;">'+jenis+' | '+kab+'</p></div><div style="padding:12px 14px;"><div style="display:grid;grid-template-columns:1fr 1fr;gap:8px;margin-bottom:10px;"><div style="background:#fff7ed;border-radius:10px;padding:10px 8px;text-align:center;border:1px solid #fdba74;"><p style="font-size:7px;font-weight:700;text-transform:uppercase;letter-spacing:0.05em;color:#F97316;margin:0 0 2px 0;">Panjang</p><p style="font-size:20px;font-weight:800;color:#1e293b;margin:0;line-height:1;">'+panjang+'</p><p style="font-size:8px;color:#94a3b8;margin:1px 0 0 0;">m</p></div><div style="background:#fff7ed;border-radius:10px;padding:10px 8px;text-align:center;border:1px solid #fdba74;"><p style="font-size:7px;font-weight:700;text-transform:uppercase;letter-spacing:0.05em;color:#F97316;margin:0 0 2px 0;">Elevasi Puncak</p><p style="font-size:20px;font-weight:800;color:#1e293b;margin:0;line-height:1;">'+elevasi+'</p><p style="font-size:8px;color:#94a3b8;margin:1px 0 0 0;">mdpl</p></div></div><div style="border-top:1px solid #f1f5f9;padding-top:8px;"><div style="display:flex;justify-content:space-between;align-items:center;padding:4px 0;"><span style="font-size:9px;color:#64748b;">Jenis</span><span style="font-size:9px;font-weight:700;color:#1e293b;">'+jenis+'</span></div><div style="display:flex;justify-content:space-between;align-items:center;padding:4px 0;"><span style="font-size:9px;color:#64748b;">Kondisi</span><span style="font-size:9px;font-weight:700;color:'+(kondisi.includes('Baik')?'#16a34a':kondisi.includes('Rusak')?'#EF4444':'#eab308')+';">'+kondisi+'</span></div><div style="display:flex;justify-content:space-between;align-items:center;padding:4px 0;"><span style="font-size:9px;color:#64748b;">Status Operasi</span><span style="font-size:9px;font-weight:700;color:#1e293b;">'+status+'</span></div><div style="display:flex;justify-content:space-between;align-items:center;padding:4px 0;"><span style="font-size:9px;color:#64748b;">Tahun</span><span style="font-size:9px;font-weight:700;color:#1e293b;">'+tahun+'</span></div><div style="display:flex;justify-content:space-between;align-items:center;padding:4px 0;"><span style="font-size:9px;color:#64748b;">DAS</span><span style="font-size:9px;font-weight:700;color:#1e293b;">'+das+'</span></div></div><div style="border-top:1px solid #f1f5f9;margin-top:8px;padding-top:8px;"><div style="display:flex;justify-content:space-between;align-items:center;padding:4px 0;"><span style="font-size:9px;color:#64748b;">Kecamatan</span><span style="font-size:9px;font-weight:700;color:#1e293b;">'+kec+'</span></div><div style="display:flex;justify-content:space-between;align-items:center;padding:4px 0;"><span style="font-size:9px;color:#64748b;">Desa</span><span style="font-size:9px;font-weight:700;color:#1e293b;">'+desa+'</span></div><div style="display:flex;justify-content:space-between;align-items:center;padding:4px 0;"><span style="font-size:9px;color:#64748b;">Manfaat</span><span style="font-size:9px;font-weight:700;color:#F97316;max-width:180px;text-align:right;">'+manfaat+'</span></div></div></div></div>';
        polyline.bindPopup(pop,{maxWidth:pw,minWidth:pw,className:'custom-leaflet-popup',offset:[0,-6]});
        var midLat=(latAwal+latAkhir)/2,midLng=(lngAwal+lngAkhir)/2;
...
// Toggle semua layer dalam satu WS (desktop)
window.toggleWS = function(ws, cb){
    ...
    layers.forEach(function(id){
        ...
        if(el) {
            ...
            // Trigger toggle
            var fakeEvent = {target: el, checked: cb.checked};
            toggleLayer(id, fakeEvent.target);
        }
    });
};

// Toggle semua layer dalam satu WS (mobile)
