    ...
    public function get_manual_data($pos_filter, $bulan, $allowed_pos) {
        ...
        if ($pos) {
            ...
            if ($pos->is_bendung == 1) {
                ...
                $this->db->where('d.id_pos', $selected_id);
                $this->db->like('d.tanggal_input', $bulan, 'after');
                ...
                $this->db->where('m.id_pos', $selected_id);
